...
class SlmParamsWindow(QtWidgets.QWidget):
    ...
    def __init__(self, store: SlmParamsStore, parent=None) -> None:
        ...
        self.ed_params_path.setToolTip("Path to the SLM parameters JSON file.")
        self.btn_browse.setToolTip("Browse for an SLM parameters JSON file.")
        self.btn_load.setToolTip("Load parameters from the selected file.")
        ...
        self.spin_nx.setToolTip("SLM horizontal pixel count.")
        self.spin_ny.setToolTip("SLM vertical pixel count.")
        ...
        self.dsb_px_side_m.setToolTip("Pixel pitch (x) in meters.")
        ...
        self.dsb_py_side_m.setToolTip("Pixel pitch (y) in meters.")
        ...
        self.dsb_fill_factor.setToolTip("Fill factor as a percentage.")
        self.spin_c2pi2unit = QtWidgets.QSpinBox()
        self.spin_c2pi2unit.setRange(1, 1024)
        self.spin_c2pi2unit.setToolTip("Phase scaling: 2π corresponds to this value.")
