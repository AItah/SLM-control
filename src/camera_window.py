...
class CameraWindow(QtWidgets.QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.chk_show_status.setToolTip("Show the status overlay text on the viewer.")
        self.chk_bind = QtWidgets.QCheckBox("Bind")
        self.chk_bind.setToolTip("Bind to the endpoint instead of connecting.")
        ...
        self.btn_start.setToolTip("Start receiving camera frames.")
        self.btn_stop.setToolTip("Stop receiving camera frames.")
        ...
        self.chk_filter.setToolTip("Zero pixels below the threshold (viewer only).")
        self.spin_filter.setToolTip("Threshold value for viewer filtering.")
